...
const Proyectos = () => {
    ...
    const [isVisibleProyect, setIsVisibleProyect] = useState(true)
        ...
        <>
            {isVisibleProyect && (
                <div className="ContainerProyects">
                    <img style={{zIndex:1000,position:'absolute', width:'2em', left:'1em',top:'10em'}} src={icon_back} onClick={hideProyect} alt="" />
